...
from ...models.undistort_spec import UndistortSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/reconstructions/{recon_id}:undistort".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        recon_id (str):
        body (UndistortSpec): ``POST /v1/reconstructions/{rid}:undistort`` — rewrite images to a
