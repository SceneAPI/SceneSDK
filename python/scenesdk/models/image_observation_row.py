...
T = TypeVar("T", bound="ImageObservationRow")


@_attrs_define
class ImageObservationRow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_observation_row.additional_properties = d
        return image_observation_row
