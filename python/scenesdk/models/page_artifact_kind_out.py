...
if TYPE_CHECKING:
    from ..models.artifact_kind_out import ArtifactKindOut


T = TypeVar("T", bound="PageArtifactKindOut")


@_attrs_define
class PageArtifactKindOut:
    """
    Attributes:
        items (list[ArtifactKindOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ArtifactKindOut.from_dict(items_item_data)
        ...
        page_artifact_kind_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_artifact_kind_out.additional_properties = d
        return page_artifact_kind_out
