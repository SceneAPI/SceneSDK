...
T = TypeVar("T", bound="ProviderOutLinksType0")


@_attrs_define
class ProviderOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_out_links_type_0.additional_properties = additional_properties
        return provider_out_links_type_0
