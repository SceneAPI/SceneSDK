...
T = TypeVar("T", bound="BackendArtifactContractOutLinksType0")


@_attrs_define
class BackendArtifactContractOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        backend_artifact_contract_out_links_type_0 = cls()
        ...
        backend_artifact_contract_out_links_type_0.additional_properties = (
            additional_properties
        )
        return backend_artifact_contract_out_links_type_0
