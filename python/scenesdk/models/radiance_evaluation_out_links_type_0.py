...
T = TypeVar("T", bound="RadianceEvaluationOutLinksType0")


@_attrs_define
class RadianceEvaluationOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        radiance_evaluation_out_links_type_0 = cls()
        ...
        radiance_evaluation_out_links_type_0.additional_properties = (
            additional_properties
        )
        return radiance_evaluation_out_links_type_0
