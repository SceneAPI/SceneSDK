...
if TYPE_CHECKING:
    from ..models.camera_model_out import CameraModelOut


T = TypeVar("T", bound="PageCameraModelOut")


@_attrs_define
class PageCameraModelOut:
    """
    Attributes:
        items (list[CameraModelOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = CameraModelOut.from_dict(items_item_data)
        ...
        page_camera_model_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_camera_model_out.additional_properties = d
        return page_camera_model_out
