...
from ...models.vocab_tree_spec import VocabTreeSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/datasets/{dataset_id}:buildVocabTree".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataset_id (str):
        body (VocabTreeSpec): ``POST /v1/datasets/{did}:buildVocabTree`` — build a reusable
