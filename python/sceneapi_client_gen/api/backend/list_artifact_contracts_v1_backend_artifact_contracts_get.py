...
) -> PageBackendArtifactContractOut | ProblemResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageBackendArtifactContractOut | ProblemResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        PageBackendArtifactContractOut | ProblemResponse
    """
