...
if TYPE_CHECKING:
    from ..models.vocab_tree_spec_backend_options import VocabTreeSpecBackendOptions


T = TypeVar("T", bound="VocabTreeSpec")
...
class VocabTreeSpec:
    ...
    (capability ``index.vocab_tree``).
        ...
        Attributes:
            ...
            backend_options (VocabTreeSpecBackendOptions | Unset): Backend-specific options. Discover supported keys with
                GET /v1/backend/config-schemas.
    """

    version: Literal[1] | Unset = 1
    provider: None | str | Unset = UNSET
    backend_options: VocabTreeSpecBackendOptions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backend_options: VocabTreeSpecBackendOptions | Unset
        if isinstance(_backend_options, Unset):
            backend_options = UNSET
        else:
            backend_options = VocabTreeSpecBackendOptions.from_dict(_backend_options)
