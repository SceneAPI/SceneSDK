...
T = TypeVar("T", bound="PageBackendConfigSchemaOut")


@_attrs_define
class PageBackendConfigSchemaOut:
    """
    Attributes:
        items (list[BackendConfigSchemaOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = BackendConfigSchemaOut.from_dict(items_item_data)
        ...
        page_backend_config_schema_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_backend_config_schema_out.additional_properties = d
        return page_backend_config_schema_out
