...
T = TypeVar("T", bound="PageProviderOut")


@_attrs_define
class PageProviderOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ProviderOut.from_dict(items_item_data)
        ...
        page_provider_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_provider_out.additional_properties = d
        return page_provider_out
