...
T = TypeVar("T", bound="PluginProcessorManifestConsumer")


@_attrs_define
class PluginProcessorManifestConsumer:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        plugin_processor_manifest_consumer = cls()
        ...
        plugin_processor_manifest_consumer.additional_properties = additional_properties
        return plugin_processor_manifest_consumer
