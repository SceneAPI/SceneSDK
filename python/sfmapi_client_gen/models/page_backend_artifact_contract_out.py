...
T = TypeVar("T", bound="PageBackendArtifactContractOut")


@_attrs_define
class PageBackendArtifactContractOut:
    """
    Attributes:
        items (list[BackendArtifactContractOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = BackendArtifactContractOut.from_dict(items_item_data)
        ...
        page_backend_artifact_contract_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_backend_artifact_contract_out.additional_properties = d
        return page_backend_artifact_contract_out
