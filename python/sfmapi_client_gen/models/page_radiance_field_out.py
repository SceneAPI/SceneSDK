...
if TYPE_CHECKING:
    from ..models.radiance_field_out import RadianceFieldOut


T = TypeVar("T", bound="PageRadianceFieldOut")


@_attrs_define
class PageRadianceFieldOut:
    """
    Attributes:
        items (list[RadianceFieldOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = RadianceFieldOut.from_dict(items_item_data)
        ...
        page_radiance_field_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_radiance_field_out.additional_properties = d
        return page_radiance_field_out
