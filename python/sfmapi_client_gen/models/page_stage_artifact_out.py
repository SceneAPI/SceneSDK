...
T = TypeVar("T", bound="PageStageArtifactOut")


@_attrs_define
class PageStageArtifactOut:
    """
    Attributes:
        items (list[StageArtifactOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = StageArtifactOut.from_dict(items_item_data)
        ...
        page_stage_artifact_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_stage_artifact_out.additional_properties = d
        return page_stage_artifact_out
