...
if TYPE_CHECKING:
    from ..models.job_detail_links_type_0 import JobDetailLinksType0
...
class JobDetail:
    ...
    list endpoints; use :class:`JobDetail` for single-job reads.
        ...
        Attributes:
            ...
            field_links (JobDetailLinksType0 | None | Unset):
            tasks (list[TaskOut] | Unset):
    """
    ...
    field_links: JobDetailLinksType0 | None | Unset = UNSET
    tasks: list[TaskOut] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.field_links, Unset):
            field_links = UNSET
        elif isinstance(self.field_links, JobDetailLinksType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_links(data: object) -> JobDetailLinksType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_links_type_0 = JobDetailLinksType0.from_dict(data)

                return field_links_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(JobDetailLinksType0 | None | Unset, data)
