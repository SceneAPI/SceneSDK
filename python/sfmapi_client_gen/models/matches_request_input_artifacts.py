...
T = TypeVar("T", bound="MatchesRequestInputArtifacts")


@_attrs_define
class MatchesRequestInputArtifacts:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        matches_request_input_artifacts = cls()
        ...
        matches_request_input_artifacts.additional_properties = additional_properties
        return matches_request_input_artifacts
