...
if TYPE_CHECKING:
    from ..models.artifact_format_out import ArtifactFormatOut


T = TypeVar("T", bound="PageArtifactFormatOut")


@_attrs_define
class PageArtifactFormatOut:
    """
    Attributes:
        items (list[ArtifactFormatOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ArtifactFormatOut.from_dict(items_item_data)
        ...
        page_artifact_format_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_artifact_format_out.additional_properties = d
        return page_artifact_format_out
