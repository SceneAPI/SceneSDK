...
T = TypeVar("T", bound="BackendOutLinksType0")


@_attrs_define
class BackendOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backend_out_links_type_0.additional_properties = additional_properties
        return backend_out_links_type_0
