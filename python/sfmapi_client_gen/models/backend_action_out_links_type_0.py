...
T = TypeVar("T", bound="BackendActionOutLinksType0")


@_attrs_define
class BackendActionOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        backend_action_out_links_type_0 = cls()
        ...
        backend_action_out_links_type_0.additional_properties = additional_properties
        return backend_action_out_links_type_0
