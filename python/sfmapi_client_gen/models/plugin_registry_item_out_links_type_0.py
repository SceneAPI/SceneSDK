...
T = TypeVar("T", bound="PluginRegistryItemOutLinksType0")


@_attrs_define
class PluginRegistryItemOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        plugin_registry_item_out_links_type_0 = cls()
        ...
        plugin_registry_item_out_links_type_0.additional_properties = (
            additional_properties
        )
        return plugin_registry_item_out_links_type_0
