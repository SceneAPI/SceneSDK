...
T = TypeVar("T", bound="PageBackendActionOut")


@_attrs_define
class PageBackendActionOut:
    """
    Attributes:
        items (list[BackendActionOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = BackendActionOut.from_dict(items_item_data)
        ...
        page_backend_action_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_backend_action_out.additional_properties = d
        return page_backend_action_out
