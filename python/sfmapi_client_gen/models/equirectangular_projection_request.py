...
T = TypeVar("T", bound="EquirectangularProjectionRequest")


@_attrs_define
class EquirectangularProjectionRequest:
    """
    Attributes:
        operation (Literal['cubemap_to_equirectangular'] | Unset):  Default: 'cubemap_to_equirectangular'.
    ...
    operation: Literal["cubemap_to_equirectangular"] | Unset = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        operation = cast(
            Literal["cubemap_to_equirectangular"] | Unset, d.pop("operation", UNSET)
        )
        if operation != "cubemap_to_equirectangular" and not isinstance(
            operation, Unset
        ):
            raise ValueError(
                f"operation must match const 'cubemap_to_equirectangular', got '{operation}'"
            )
        ...
        equirectangular_projection_request = cls(
            operation=operation,
            cubemap=cubemap,
        ...
        equirectangular_projection_request.additional_properties = d
        return equirectangular_projection_request
