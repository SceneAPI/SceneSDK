...
if TYPE_CHECKING:
    from ..models.plugin_registry_item_out import PluginRegistryItemOut


T = TypeVar("T", bound="PagePluginRegistryItemOut")


@_attrs_define
class PagePluginRegistryItemOut:
    """
    Attributes:
        items (list[PluginRegistryItemOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PluginRegistryItemOut.from_dict(items_item_data)
        ...
        page_plugin_registry_item_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_plugin_registry_item_out.additional_properties = d
        return page_plugin_registry_item_out
