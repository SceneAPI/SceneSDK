...
if TYPE_CHECKING:
    from ..models.plugin_entry_point_out import PluginEntryPointOut


T = TypeVar("T", bound="PagePluginEntryPointOut")


@_attrs_define
class PagePluginEntryPointOut:
    """
    Attributes:
        items (list[PluginEntryPointOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PluginEntryPointOut.from_dict(items_item_data)
        ...
        page_plugin_entry_point_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_plugin_entry_point_out.additional_properties = d
        return page_plugin_entry_point_out
