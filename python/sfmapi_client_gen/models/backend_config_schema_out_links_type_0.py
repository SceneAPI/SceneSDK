...
T = TypeVar("T", bound="BackendConfigSchemaOutLinksType0")


@_attrs_define
class BackendConfigSchemaOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        backend_config_schema_out_links_type_0 = cls()
        ...
        backend_config_schema_out_links_type_0.additional_properties = (
            additional_properties
        )
        return backend_config_schema_out_links_type_0
