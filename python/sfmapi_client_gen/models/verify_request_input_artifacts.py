...
T = TypeVar("T", bound="VerifyRequestInputArtifacts")


@_attrs_define
class VerifyRequestInputArtifacts:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        verify_request_input_artifacts = cls()
        ...
        verify_request_input_artifacts.additional_properties = additional_properties
        return verify_request_input_artifacts
