...
T = TypeVar("T", bound="PluginDetailOutLinksType0")


@_attrs_define
class PluginDetailOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        plugin_detail_out_links_type_0 = cls()
        ...
        plugin_detail_out_links_type_0.additional_properties = additional_properties
        return plugin_detail_out_links_type_0
