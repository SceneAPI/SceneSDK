...
if TYPE_CHECKING:
    from ..models.radiance_evaluation_out import RadianceEvaluationOut


T = TypeVar("T", bound="PageRadianceEvaluationOut")


@_attrs_define
class PageRadianceEvaluationOut:
    """
    Attributes:
        items (list[RadianceEvaluationOut]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = RadianceEvaluationOut.from_dict(items_item_data)
        ...
        page_radiance_evaluation_out = cls(
            items=items,
            next_page_token=next_page_token,
            total=total,
        )

        page_radiance_evaluation_out.additional_properties = d
        return page_radiance_evaluation_out
