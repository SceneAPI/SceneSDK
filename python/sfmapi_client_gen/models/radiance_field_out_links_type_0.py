...
T = TypeVar("T", bound="RadianceFieldOutLinksType0")


@_attrs_define
class RadianceFieldOutLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        radiance_field_out_links_type_0 = cls()
        ...
        radiance_field_out_links_type_0.additional_properties = additional_properties
        return radiance_field_out_links_type_0
