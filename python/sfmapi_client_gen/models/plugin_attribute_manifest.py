...
from ..models.plugin_attribute_manifest_type import PluginAttributeManifestType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PluginAttributeManifest")


@_attrs_define
class PluginAttributeManifest:
    """
    Attributes:
        name (str):
        type_ (PluginAttributeManifestType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PluginAttributeManifestType(d.pop("type"))
        ...
        return plugin_attribute_manifest
