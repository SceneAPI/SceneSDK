...
T = TypeVar("T", bound="CubemapProjectionRequest")


@_attrs_define
class CubemapProjectionRequest:
    """
    Attributes:
        operation (Literal['equirectangular_to_cubemap'] | Unset):  Default: 'equirectangular_to_cubemap'.
    ...
    operation: Literal["equirectangular_to_cubemap"] | Unset = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        operation = cast(
            Literal["equirectangular_to_cubemap"] | Unset, d.pop("operation", UNSET)
        )
        if operation != "equirectangular_to_cubemap" and not isinstance(
            operation, Unset
        ):
            raise ValueError(
                f"operation must match const 'equirectangular_to_cubemap', got '{operation}'"
            )
        ...
        cubemap_projection_request = cls(
            operation=operation,
            cubemap=cubemap,
        ...
        cubemap_projection_request.additional_properties = d
        return cubemap_projection_request
