...
from ...models.export_spec import ExportSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/reconstructions/{recon_id}:export".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        recon_id (str):
        body (ExportSpec): ``POST /v1/reconstructions/{rid}:export`` — export the sparse model
