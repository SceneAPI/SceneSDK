...
from ...models.triangulate_spec import TriangulateSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/reconstructions/{recon_id}:triangulate".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        recon_id (str):
        body (TriangulateSpec): ``POST /v1/reconstructions/{rid}:triangulate`` — re-triangulate
