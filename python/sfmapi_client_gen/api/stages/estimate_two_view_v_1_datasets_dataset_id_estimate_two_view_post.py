...
from ...models.two_view_spec import TwoViewSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/datasets/{dataset_id}:estimateTwoView".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataset_id (str):
        body (TwoViewSpec): ``POST /v1/datasets/{did}:estimateTwoView`` — estimate two-view
