...
from ...models.pose_graph_spec import PoseGraphSpec
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/reconstructions/{recon_id}:poseGraphOptimize".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        recon_id (str):
        body (PoseGraphSpec): ``POST /v1/reconstructions/{rid}:poseGraphOptimize`` — pose-graph
