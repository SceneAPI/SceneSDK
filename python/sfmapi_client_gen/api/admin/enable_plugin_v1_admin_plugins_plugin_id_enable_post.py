...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/admin/plugins/{plugin_id}:enable".format(
...
) -> HTTPValidationError | PluginDetailOut | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PluginDetailOut]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | PluginDetailOut
    """
