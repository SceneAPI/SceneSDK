...
from ...models.page_plugin_registry_item_out import PagePluginRegistryItemOut
...
) -> HTTPValidationError | PagePluginRegistryItemOut | None:
    if response.status_code == 200:
        response_200 = PagePluginRegistryItemOut.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | PagePluginRegistryItemOut]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | PagePluginRegistryItemOut
    """
