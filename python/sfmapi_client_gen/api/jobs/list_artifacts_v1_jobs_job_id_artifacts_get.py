...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/jobs/{job_id}/artifacts".format(
...
) -> PageStageArtifactOut | ProblemResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PageStageArtifactOut | ProblemResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        kind (None | str | Unset): Optional exact artifact kind filter, e.g. matches.verified.v1.
...
def sync(
    ...
    *,
    ...
    Returns:
        PageStageArtifactOut | ProblemResponse
    """
